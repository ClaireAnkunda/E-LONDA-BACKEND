...
const createTransporter = () => {
  ...
  if (!emailUser || !emailPassword) {
    ...
    console.warn('   Current EMAIL_USER:', emailUser || 'NOT SET');
    console.warn('   Current EMAIL_APP_PASSWORD:', emailPassword ? 'SET (length: ' + emailPassword.length + ')' : 'NOT SET');
    return null;
  }
  ...
  if (cleanPassword.length !== 16) {
    console.warn('⚠️  EMAIL_APP_PASSWORD should be exactly 16 characters (after removing spaces)');
    console.warn('   Current length:', cleanPassword.length);
    console.warn('   Make sure you copied the full App Password from Google');
  }
